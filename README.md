...
Ops notes for request IDs, rate limits, verified backups, mounted off-host backup copies, and restore are in [docs/ops.md](/Users/maximiliannordler/code/math-for-agents/docs/ops.md).
